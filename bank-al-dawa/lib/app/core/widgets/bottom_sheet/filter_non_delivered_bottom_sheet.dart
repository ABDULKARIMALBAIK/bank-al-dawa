...
class FilterNonDeliveredBottomSheet {
  static Future<void> showFilterDialog(
      BuildContext context, NonDeliveredReportsController controller) async {
  ...
  static SizedBox _employeeDropdown(
      BuildContext context, NonDeliveredReportsController controller) {
    /*
    SizedBox(
      width: 350,
  ...
  // ignore: non_constant_identifier_names
  static StateBuilder<NonDeliveredReportsController> _ListRegions(
      BuildContext context, NonDeliveredReportsController controller) {
    return StateBuilder<NonDeliveredReportsController>(
      key: UniqueKey(),
