...
class TransferReportsReviewerBottomSheet {
            ...
            return SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _dropdownEmployee(
                      context, 'من', controller, EmployeeStatus.old),
                  const SizedBox(
                    height: 15,
                  ),
                  ...
                  ////////////////////////////// * Employee Dropdown TextField  * //////////////////////////////
                  _dropdownEmployee(
                      context, 'إلى', controller, EmployeeStatus.now),
                  const SizedBox(
                    height: 15,
                  ),
  ...
  static Padding _subtitle(BuildContext context) {
    return Padding(
        padding:
            const EdgeInsets.only(top: 15, bottom: 12, left: 24, right: 24),
        child: Text('اختر الموظف المناسب لنقل كشوفات إليه :',
            textAlign: TextAlign.center,
            overflow: TextOverflow.ellipsis,
            maxLines: 3,
  ...
  static Padding _dropdownEmployee(BuildContext context, String title,
      HomeController controller, EmployeeStatus status) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          GetBuilder<HomeController>(
            id: status == EmployeeStatus.old
                ? controller.employeeOldId
                : controller.employeeNewId,
            builder: (controllers) {
                ...
                child: StatefulBuilder(
                  builder: (context, StateSetter searchState) {
                    return SearchChoices.single(
                      ...
                      value: status == EmployeeStatus.old
                          ? controller.selectedOldEmployee
                          : controller.selectedNewEmployee,
                      hint: Text(
                      ...
                      onChanged: (newEmployee) {
                        searchState(() {
                          status == EmployeeStatus.old
                              ? controller.selectedOldEmployee = newEmployee
                              : controller.selectedNewEmployee = newEmployee;
                        });
                        //
                        // controller.update();
